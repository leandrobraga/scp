...
class CreateUserMaster(wx.Frame):
    ...
    def __init__(self):
        ...
        wx.Frame.__init__(self,None,id=wx.ID_ANY,size=(520,300),pos=(300,170),title="Cadastro do Administrador do Sistema",style= wx.SYSTEM_MENU | wx.CAPTION | wx.CLIP_CHILDREN)
        self.panelUser = wx.Panel(self, wx.ID_ANY)

        self.welcomeStaticText = wx.StaticText(self.panelUser,-1,'Antes de finalizar o processo de instalação é necessário fazer o cadastro de um usuário administrador.\nInforme os campos abaixo para fazer o cadastro deste usuário!',pos=(10,10),style=wx.ALIGN_LEFT)
